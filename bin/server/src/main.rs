...
use clap::Parser;
use sp1_sdk::{
    network::proto::artifact::artifact_store_server::ArtifactStoreServer,
    private::proto::private_prover_server::PrivateProverServer,
};
...
use crate::{
    ...
    artifact_store_server::DefaultArtifactStoreServer,
    cli::Args,
    db::InMemoryDb,
...
async fn main() {
    ...
    routes_builder.add_service(PrivateProverServer::new(DefaultPrivateProverServer::new(
        args.hostname.clone(),
        db.clone(),
        args.worker_count,
    )));
